...
public class SkinConfig implements ResourcesType{

    @Override
    public ResourcesType init() {
        JsonReader json = new JsonReader();
        JsonValue jsonData = json.parse(Gdx.files.internal("config/type/skin.json"));

        for(JsonValue category = jsonData.getChild("skin"); category != null; category = category.next()) {
